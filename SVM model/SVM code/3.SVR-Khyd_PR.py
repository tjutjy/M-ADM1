...
pattern=list()
fhd=csv.reader(open('K_hyd_PR data.csv','r'))
for line in fhd:
    pattern.append(line)

#raw_sample
raw_sample=list()
fhd=csv.reader(open('K_hyd_PR predict.csv','r'))
for line in fhd:
    raw_sample.append(line)

#label
label=list()
fhl=csv.reader(open('K_hyd_PR Standard.csv','r'))
for line in fhl:
    label.append(line)
...
predict = list()
fhp = csv.reader(open('K_hyd_PR predict.csv','r'))
for line in fhd:
    predict.append(line)
